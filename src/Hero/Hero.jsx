      ...
      <div className="min-h-[400px] overflow-hidden pb-36 pt-44 md:pb-0 md:pt-20 lg:pt-36">
        <Reveal>
          {isPolish ? (
            <h1 className="text-4xl font-semibold sm:text-6xl md:text-8xl">
             Cześć, tu Alex<span className="text-primary">.</span>
            </h1>
          ) : (
            <h1 className="text-4xl font-semibold sm:text-6xl md:text-8xl">
        ...
        <Reveal>
          <p className="font-italy max-w-xl leading-relaxed md:text-base md:leading-relaxed">
            ...
            building both front-end and back-end projects. I&apos;m now on the
            lookout to land my first developer role and bring those skills to
            life! Let&apos;s connect!
          </p>
        </Reveal>
        <Reveal>
